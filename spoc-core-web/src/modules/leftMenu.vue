...
<template>
	<div class="leftMenu">
        ...
        <div class="tabs">
            ...
            <div class="itemone" @click.stop="switchTab(2)" :class="{'active':tab==2}" >岗位管理</div>
            <div class="itemone" v-if="menus.length>=3" @click.stop="switchTab(3)" :class="{'active':tab==3}" >职能等级</div>
        </div>
