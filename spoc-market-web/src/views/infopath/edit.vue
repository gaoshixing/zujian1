		...
		<div class="formSettingC" v-if="tabValue=='name1'">
			<Form ref="formInline" :model="infor" :rules="ruleInfor" :label-width="85">
				...
				<FormItem prop="remarks" label="表单说明：">
					<Input v-model="infor.remarks" type="textarea" style="width:100%"  :maxlength="100" :autosize="{minRows: 2,maxRows: 5}" placeholder="请填写备注"></Input>
				</FormItem>
			</Form>
		</div>
		<Button type="primary" @click="saveInfo('formInline')" style="margin:30px 0 0 90px" size='large'>保存</Button>
