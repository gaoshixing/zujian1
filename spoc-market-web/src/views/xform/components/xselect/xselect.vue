                ...
                <div class="x-select-able" :rel="xoptions" :style="inputs">
                    ...
                    <div class="x-select-dropdown" v-if="showList" :style="hasScroll">
                        <div class="x-select-dropdown-wrap">
                            <div class="x-select-dropdown-item" :class="{hover:currIndex===index,active:value==item.value}" v-for="(item,index) in ctx.options" :key="index" @click.stop="onItemClick(item,index)" v-html="item[k]">{{item}}</div>
                        </div>
                    </div>
                </div>
            </div>
