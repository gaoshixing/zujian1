...
<template>
    <div class="item-settings-wrap">
		<xform :isSetting="true" ref="xform" @on-change="onChange" @on-click="onClick" :xdata="data" :xsetting="xsetting" :xformdata="xform.layout" />
    </div>
</template>
<script>
...
export default {
    ...
    methods:{
        ...
        onChange(el,index,flag){
            this.$emit('on-change',el,index,flag);
