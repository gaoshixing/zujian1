...
const v = {type:'notNull',required:true,trigger:'blur',message:'此为必填项'};
const vars = {type:'userName',regex:/^[a-zA-Z]+\w{0,20}$/.source,trigger:'change',message:'需为字母开头,可包含数字、字母、下划线' };
const v_phone = {type:'phone',trigger:'blur',message:'请输入正确的手机号'};
const v_email = {type:'email',trigger:'blur',message:'请输入正确的邮箱'};
const v_max = {type:'max',regex:/^.{1,8}$/.source,trigger:'blur',message:'请输入1-8位字符'};
				...
				return [
					{
						...
						settings:{
							...
							optionsOnly:isFirst?null:[fitem?fitem.settings.category:''],
