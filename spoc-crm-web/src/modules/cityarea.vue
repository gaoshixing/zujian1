<template>
    <div>
        <Select filterable v-model="country" style="width:33%" @on-change="onTreeCountryChange">
            <Option v-for="c1 in cityTree.country" :key="c1.id" :value="c1.id">{{c1.name}}</Option>
        </Select>
        <Select v-if="s2flag" filterable v-model="province" style="width:32%" @on-change="onTreeProvinceChange">
            <Option v-for="c2 in cityTree.province" :key="c2.id" :value="c2.id">{{c2.name}}</Option>
        </Select>
        <Select v-if="s3flag" filterable v-model="city" style="width:30%">
