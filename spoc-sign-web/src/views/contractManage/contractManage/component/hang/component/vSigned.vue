// 已签约
<style lang="less">
.sign-contract-manage-signed-container{
	@blue:#44bcb7;
	@red:#ff0000;
	.abstract{
		font-size: 18px;
...
<template>
	<div class="sign-contract-manage-signed-container">
		<div class="abstract">
			累计收到 <span class="blue">330</span> 份已签约合同，签约总金额 <span class="red">5000</span> 万，实际优惠后总金额 <span class="red">4500</span> 万
		</div>
		...
		<!-- 转让 -->
		<Modal title="转让合同" v-model="modalShow.showTransfer">
			<div>等ui吧-_-||</div>
		</Modal>

		<!-- 补充 -->
		<Modal title="补充合同" v-model="modalShow.showSupplement">
			<div>等ui吧-_-||</div>
		</Modal>
	</div>
</template>
...
export default {
	...
	methods: {
		...
		showTransfer(params){
			this.modalShow.showTransfer = true;
		},
		showSupplement(params){
			this.modalShow.showSupplement = true;
		},
