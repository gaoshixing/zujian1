...
<script>
import valid,{errors,choiceschool} from "../libs/request.js";
...
export default {
    ...
    methods:{
        ...
        listAssigndUser(){//已添加人员
            ...
            choiceschool.findByIds(params).then(valid.call(this)).then(res=>{
                if(res.ok){
                	console.log(res)
...
//          }).catch(errors.call(this));
        ...
        searchData(param){
        	...
        	console.log(param)
            this.updateLoadingStatus({isLoading: true});
            choiceschool.listAllUserMap(param).then(valid.call(this)).then(res=>{
            	console.log(res)
