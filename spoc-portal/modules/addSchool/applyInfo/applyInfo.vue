	...
	<div class="applyInfo">
		...
		<Form ref="formApply" :model="formApply" :rules="applyRule" :show-message="true" :label-width="126" class="formApply">
			...
			<div class="formBox" v-show="toggle[0]">
	        	...
	        	<div class="nextBtn" v-show="toggle[0]"><Button type="primary" @click="nextTo(1)" class="button">保存并下一步</Button></div>
    		...
    		<div class="nextBtn" v-show="toggle[1]"><Button type="primary" @click="nextTo(2)" class="button">保存并下一步</Button></div>
    		...
    		<div class="nextBtn" v-show="toggle[2]"><Button type="primary" @click="nextTo(3)" class="button">保存并下一步</Button></div>
    		...
    		<div class="nextBtn" v-show="toggle[3]"><Button type="primary" @click="handleSubmit('formApply')" class="button">保存并下一步</Button></div>
		</Form>
	</div>
</template>
