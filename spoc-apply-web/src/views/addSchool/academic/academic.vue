...
<template>
	<div class="academic">
		...
		<Button type="primary" @click="handleSubmit('formBasic')" class="submit" :disabled="$route.query.edit==1">保存并下一步</Button>
...
<script>
import vSelect from "@/component/spoc-library-web/src/modules/vSelect.vue";
