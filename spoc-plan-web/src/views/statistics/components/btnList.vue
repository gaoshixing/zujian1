...
<template>
    <div class="btnlist">
        ...
        <div class="btnright">
            <Button type="ghost" class="bt1" @click="del" v-show="isShow" v-if="btnItem[0].cont">{{btnItem[0].cont}}</Button>
            ...
            <Button type="ghost" class="bt2" @click="importTo" v-if="btnItem[2].cont">{{btnItem[2].cont}}</Button>
