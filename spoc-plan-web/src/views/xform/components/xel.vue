...
<template>
    <div class="xel-item" v-if="data.visible||1" :class="xelCls">
        ...
        <xbutton ref="el" v-else-if="model===TYPES.BUTTON" :id="data.id" :pid="pid" :name="data.name" v-model="data.value" :type="data.type" :display="data.display" :readonly="viewonly" :payload="mypayload" :cls="data.cls" @on-click="onClick" />
