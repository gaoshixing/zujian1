                ...
                <div class="infoBox" v-show="secShow">
                    ...
                    <Form ref="secStepForm" inline :label-width="150">
                        <div class="examineBox studyInfoBox clearfix" v-scrollto="item"  v-for="(item,index) in xxStudyinfoList" :key="'study_'+index">
                            <div class="deleteBox" @click.stop.prevent="deleteStudyInfo(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                ...
                <div class="infoBox" v-show="thirdShow">
                    ...
                    <Form ref="examineForm" :label-width="100" inline style="padding-left:60px;">
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxTOEFLList" :key="'tf_'+index">
                            <div class="deleteBox" @click="deleteTOEFL(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon TOEFL"></div>
                                <div class="typeName">TOEFL</div>
                                <div class="expectFlag"><Checkbox v-model="item.expectFlag">{{$t("XxExamScore.expectFlag")}}</Checkbox></div>
                            </div>
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxTOEFLJuniorList" :key="'jun_'+index">
                            <div class="deleteBox" @click="deleteTOEFLJunior(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon TOEFLJunior"></div>
                                <div class="typeName">TOEFLJunior</div>
                                <div class="expectFlag"><Checkbox v-model="item.expectFlag">{{$t("XxExamScore.expectFlag")}}</Checkbox></div>
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxIELTSList" :key="'ya_'+index">
                            <div class="deleteBox" @click="deleteIELTS(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon IELTS"></div>
                                <div class="typeName">IELTS</div>
                                <div class="expectFlag"><Checkbox v-model="item.expectFlag">{{$t("XxExamScore.expectFlag")}}</Checkbox></div>
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxSATList" :key="'sat_'+index">
                            <div class="deleteBox" @click="deleteSAT(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon SAT"></div>
                                <div class="typeName">SAT</div>
                                <div class="expectFlag"><Checkbox v-model="item.expectFlag">{{$t("XxExamScore.expectFlag")}}</Checkbox></div>
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxACTList" :key="'act_'+index">
                            <div class="deleteBox" @click="deleteACT(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon ACT"></div>
                                <div class="typeName">ACT</div>
                                <div class="expectFlag"><Checkbox v-model="item.expectFlag">{{$t("XxExamScore.expectFlag")}}</Checkbox></div>
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxGREList" :key="'gre_'+index">
                            <div class="deleteBox" @click="deleteGRE(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon GRE"></div>
                                <div class="typeName">GRE</div>
                                <div class="expectFlag"><Checkbox v-model="item.expectFlag">{{$t("XxExamScore.expectFlag")}}</Checkbox></div>
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxGMATList" :key="'gmat_'+index">
                            <div class="deleteBox" @click="deleteGMAT(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon GMAT"></div>
                                <div class="typeName">GMAT</div>
                                <div class="expectFlag"><Checkbox v-model="item.expectFlag">{{$t("XxExamScore.expectFlag")}}</Checkbox></div>
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxLSATList" :key="'lsat_'+index">
                            <div class="deleteBox" @click="deleteLSAT(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon LSAT"></div>
                                <div class="typeName">LSAT</div>
                                <div class="expectFlag"><Checkbox v-model="item.expectFlag">{{$t("XxExamScore.expectFlag")}}</Checkbox></div>
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxSATIIList" :key="'satii_'+index">
                            <div class="deleteBox" @click="deleteSATII(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon SATII"></div>
                                <div class="typeName">SAT II</div>
                            </div>
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxAPList" :key="'ap_'+index">
                            <div class="deleteBox" @click="deleteAP(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon AP"></div>
                                <div class="typeName">AP</div>
                            </div>
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxSSATList" :key="'ssat_'+index">
                            <div class="deleteBox" @click="deleteSSAT(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon SSAT"></div>
                                <div class="typeName">SSAT</div>
                                <div class="expectFlag"><Checkbox v-model="item.expectFlag">{{$t("XxExamScore.expectFlag")}}</Checkbox></div>
                        ...
                        <div class="examineBox clearfix" v-scrollto="item" v-for="(item,index) in xxOthersExamList" :key="'ot_'+index">
                            <div class="deleteBox" @click="deleteOthers(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon others"></div>
                ...
                <div class="infoBox" v-show="fourShow">
                    ...
                    <Form ref="fourStepForm" inline label-position="top" style="padding-left:60px;">
                        <div class="examineBox skillBox clearfix" v-scrollto="item" v-for="(item,index) in honorsList" :key="'f1_'+index">
                            <div class="deleteBox" @click="deleteHonour(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon honour"></div>
                                <div class="typeName">{{$t('XxSkillinfo.honors')}}</div>
                            </div>
                        ...
                        <div class="examineBox skillBox clearfix" v-scrollto="item" v-for="(item,index) in extraActivitiesList" :key="'f12_'+index">
                            <div class="deleteBox" @click="deleteExtraActivities(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon kewai"></div>
                                <div class="typeName">{{$t('XxSkillinfo.extraActivities')}}</div>
                            </div>
                        ...
                        <div class="examineBox skillBox clearfix" v-scrollto="item" v-for="(item,index) in interExperienceList" :key="'f13_'+index">
                            <div class="deleteBox" @click="deleteInterExperience(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon shixi"></div>
                                <div class="typeName">{{$t('XxSkillinfo.interExperience')}}</div>
                            </div>
                        ...
                        <div class="examineBox skillBox clearfix" v-scrollto="item" v-for="(item,index) in researchExperienceList" :key="'f14_'+index">
                            <div class="deleteBox" @click="deleteResearchExperience(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon yanjiu"></div>
                                <div class="typeName">{{$t('XxSkillinfo.researchExperience')}}</div>
                            </div>
                        ...
                        <div class="examineBox skillBox clearfix" v-scrollto="item" v-for="(item,index) in skillsHobbiesList" :key="'f15_'+index">
                            <div class="deleteBox" @click="deleteSkillsHobbies(index)"><Icon type="close-round"></Icon></div>
                            <div class="testTitle">
                                <div class="typeIcon jineng"></div>
                                <div class="typeName">{{$t('XxSkillinfo.skillsHobbies')}}</div>
                            </div>
...
import addSchoolItem from './addSchoolItem';
...
const numberreg =  [
                    { required: true, type: 'string', message: '请输入正确的手机号', trigger: 'blur'}
                ]
const mailregnoreq = [
...
const req = [
                { required: true, type: 'string', message: '此项为必填', trigger: 'blur' }
            ];
const requ = '此项为必填';
export default {
    props:{
    ...
    data(){
        return {
            ...
            xxInnerinfoRule:{
                ...
                teacherSale:[
                    {required: true, message: requ, trigger: 'blur'}
                ],
                teacherPlan:[
                    {required: true, message: requ, trigger: 'blur'}
                ],
            ...
            basicFormValidate:{
                firstName:[
                    { required: true, message: requ, trigger: 'blur' },
                    { type: 'string', pattern: /^[\u4e00-\u9fa5·.\w\-]{1,120}$/, message: '须输入汉字、字母、连字符等,长度不大于120', trigger: 'blur'}
                ],
                lastName:[
                    { required: true, message: requ, trigger: 'blur' },
                    { type: 'string', pattern: /^[\u4e00-\u9fa5·.\w\-]{1,120}$/, message: '须输入汉字、字母、连字符等,长度不大于120', trigger: 'blur'}
                ...
                firstNamePinYin:[
                    { required: true, message: requ, trigger: 'blur' },
                    { type: 'string', pattern: /^[\u4e00-\u9fa5·.\w\-]{1,120}$/, message: '须输入拼音字母长度不大于120', trigger: 'blur'}
                ],
                lastNamePinYin:[
                    { required: true, message: requ, trigger: 'blur' },
                    { type: 'string', pattern: /^[\u4e00-\u9fa5·.\w\-]{1,120}$/, message: '须输入拼音字母长度不大于120', trigger: 'blur'}
                ...
                enName:[
                    { type: 'string', pattern: /^[·.\w\-\s]{1,120}$/, message: '须输入英文、连字符,长度不大于120', trigger: 'blur'}
                ],
                gender:[
                    { required: true, message: requ, trigger: 'change' }
                ],
                skypeId:[
                    { required: true, message: requ, trigger: 'blur' }
                ],
                ...
                applyTime:[
                    { required: true, message: requ, trigger: 'blur' },
                    { type:'string',pattern:/^20\d{2}\/[a-zA-Z]{1,9}$/,message:'格式需为2019/F',trigger:'blur' }
                ],
                grade:[
                    { required: true, message: requ, trigger: 'change' }
                ],
                ...
                wechat:[
                    { required: true, message: '微信号是必填项', trigger: 'blur' }
                ],
                amount:[
                    { required: true, message: requ, trigger: 'blur' },
                    { type: 'string', pattern: /^[1-9](\d*)$/, message: '请填写正整数', trigger: 'blur'}
                ],
                freeAmount:[
                    { required: true, message: requ, trigger: 'blur' },
                    { type: 'string', pattern: /^\d+$/, message: '请填写正整数', trigger: 'blur'}
                ],
                moneyAmount:[
                    { required: true, message: requ, trigger: 'blur' },
                    { type: 'string', pattern: /^\d+$/, message: '请填写正整数', trigger: 'blur'}
    ...
    methods: {
        ...
        getStudentInfo(_data){//获取学生信息
            ...
            util.ajax.get(nozzle.xxStudent.form,{params:_data}).then(function(res){
                util.checkAjaxJson(res).thenSuccess(function(json){
                    ...
                    for(let item in json.data){
                        if(item in _this.xxStudent){
                            if(typeof json.data[item] !='undefined' && !isNaN(json.data[item])){
                                _this.xxStudent[item]=json.data[item] != null ? json.data[item].toString() : '';
                            }else{
        ...
        onCountryChange(id,cb){
            ...
            this.getAreaListData(id,data=>{
                if(data.data.length){
                    ...
                    if(item){
                        const itemarr = [Object.assign({},item,{id:'-1'})];
        ...
        basicInfoSave(name){//保存基本信息
            this.$refs[name].validate((valid) => {
                if(valid){
                    ...
                    this.xxStudent.menuId= this.pid;
        ...
        secStepInfoSave(){//保存学习经历
            ...
            const copyed = (JSON.parse(JSON.stringify(this.xxStudyinfoList))).map(v=>{delete v.typeItem;delete v.edited; return v; });
            ...
            util.ajax.post(nozzle.xxStudent.saveXxApplyobject,this.xxApplyobject).then(function(res){
                util.checkAjaxJson(res).thenSuccess(function(json){
                    ...
                    if(_this.inRoleArray('7') || _this.inRoleArray('9')){
                        _this.$router.push({name:"choiceschool.schoolApproval"});
                    }else{
                        _this.$router.push({name:"choiceschool.studentList"});
                    }
                }).autoRun("login","error");
                _this.updateLoadingStatus({isLoading:false});
            }).catch(function(error) {
        ...
        searchCountry(text,cb){
            var _this=this;
            const _data={name:text,level:2};
            util.ajax.get(nozzle.basicData.findByName,{params:_data}).then(function(res){
                util.checkAjaxJson(res).thenSuccess(function(json){
                    cb(json);
                }).autoRun("login","error");
            }).catch(function(error) {
    ...
    mounted() {
        ...
        if(this.chineseUser){
            ...
            this.getDictList({type:"xx_innerinfo_type"},function(_data){
        ...
        this.getDictList({type:'xx_student_grade'},data=>{
            this.gradeTypeList = data;
        });
        this.getDictList({type:'xx_student_apply'},data=>{
            this.applyTypeList = data;
        });
        this.getDictList({type:'xx_studyinfo_type'},data=>{
            this.xxStudyInfoType = data;
        });
        this.getDictList({type:'xx_studyinfo_level'},data=>{
            this.xxStudyInfoLevel = data;
        });
        this.getDictList({type:'xx_innerinfo_country'},data=>{
...
.stepInfoList{
    .nameIcon{
        background-image: url("../../assets/images/addStudent/icon_name.png");
    }
    .boshiIcon{
        background-image: url("../../assets/images/addStudent/icon_boshi.png");
    }
    .testIcon{
        background-image: url("../../assets/images/addStudent/icon_test.png");
    }
    .acitivityIcon{
        background-image: url("../../assets/images/addStudent/icon_activity.png");
    }
    .schoolIcon{
        background-image: url("../../assets/images/addStudent/icon_school.png");
    }
}
...
.tipIcon{
    background-image: url("../../assets/images/addStudent/icon_tipInfo.png");
}
.stepContent{
...
.mainContent{
    ...
    .stepInfoList{
        ...
        .complete{
            ...
            right: 50px;
            opacity: 0.5;
            background-image: url("../../assets/images/addStudent/icon_complete.png");
            background-repeat: no-repeat;
        }
    }
    .basicStep{
    ...
    .SSAT{
        background-image: url("../../assets/images/addStudent/SSAT.png");
    }
    .SATII{
        background-image: url("../../assets/images/addStudent/SATII.png");
    }
    .AP{
        background-image: url("../../assets/images/addStudent/AP.png");
    }
    .TOEFLJunior{
        background-image: url("../../assets/images/addStudent/TOEFLJunior.png");
    }
    .else{
        background-image: url("../../assets/images/addStudent/icon_add.png");
...
.scrolltop{
    ...
    border-radius: 100%;
    z-index: 10001;
    background: url("../../assets/images/public/scrollTop.png") no-repeat center center #e6e6e6;
